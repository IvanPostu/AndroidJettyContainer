 ...
 */
public class JettyServerService extends Service {
    private static final String TAG = "Jetty";

    private static Resources __resources;
    private static final String CONTENT_RESOLVER_ATTRIBUTE = "com.ipostu.androidjettycontainer.contentResolver";
    private static final String ANDROID_CONTEXT_ATTRIBUTE = "com.ipostu.androidjettycontainer.context";
    ...
    public class LocalBinder extends Binder {
        JettyServerService getService() {
            // Return this instance of LocalService so clients can call public methods
            return JettyServerService.this;
        }
    }
        ...
        _handler = new android.os.Handler() {
            public void handleMessage(Message msg) {
                switch (msg.getData().getInt("state")) {
                    case __STARTED: {
                        AppTools.showServiceToast(JettyServerService.this, R.string.jetty_started);
...
//                        mNM.notify(R.string.jetty_started, notification);
                        ...
                        Notification.Builder builder = new Notification.Builder(JettyServerService.this);
                    ...
                    case __NOT_STARTED: {
                        AppTools.showServiceToast(JettyServerService.this, R.string.jetty_not_started);
                        break;
                    }
                    case __STOPPED: {
                    ...
                    case __NOT_STOPPED: {
                        AppTools.showServiceToast(JettyServerService.this, R.string.jetty_not_stopped);
                        break;
                    }
                    case __STARTING: {
                        AppTools.showServiceToast(JettyServerService.this, R.string.jetty_starting);
                        break;
                    }
                    case __STOPPING: {
                        AppTools.showServiceToast(JettyServerService.this, R.string.jetty_stopping);
                        break;
                    }
                }
    ...
    public void onStart(Intent intent, int startId) {
        if (server != null) {
            AppTools.showServiceToast(JettyServerService.this, R.string.jetty_already_started);
            return;
        }
    ...
    public void onDestroy() {
        try {
            ...
            if (server != null) {
                ...
                AppTools.showServiceToast(JettyServerService.this, R.string.jetty_not_running);
            }
        } catch (Exception e) {
